...
AddTextEntry('COMS1T_LIV37', 'Shape of a Pony')
AddTextEntry('COMS1T_LIV38', 'Jakeys Lager #17')
AddTextEntry('COMS1T_LIV39', 'Dusche Racing #189')
AddTextEntry('COMS1T_LIV40', 'Coverup Paints')
AddTextEntry('COMS1T_LIV41', 'Coverup Paints (Alt)')

AddTextEntry('COMS1T_GUTTER1', 'Painted Gutter')
AddTextEntry('CS1T_MIRROR_3', 'Facelift Mirrors')
end)
