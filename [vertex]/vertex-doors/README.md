...
> After running migration commands, restart `vertex-doors` for changes to take effect.
...
| Resource | Why |
|----------|-----|
| `vertex-base` | Core framework |
| `vertex-pwnzor` | Anti-cheat |
| `vertex-admin` | Admin panel UI for door/elevator management |
