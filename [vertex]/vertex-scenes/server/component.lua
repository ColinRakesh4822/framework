...
function RetrieveComponents()
    ...
    Scenes = exports['vertex-base']:FetchComponent('Scenes')
end

AddEventHandler('Core:Shared:Ready', function()
	exports['vertex-base']:RequestDependencies('Scenes', {
		'Fetch',
		'Utils',
        'Execute',
        'Chat',
		...
		if #error > 0 then 
            exports['vertex-base']:FetchComponent('Logger'):Critical('Scenes', 'Failed To Load All Dependencies')
			return
		end
		RetrieveComponents()
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['vertex-base']:RegisterComponent('Scenes', _SCENES)
end)
