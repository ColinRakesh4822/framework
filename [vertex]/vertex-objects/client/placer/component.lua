...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("ObjectPlacer", {
        "Notification",
        "Targeting",
        "ObjectPlacer",
	}, function(error)
		if #error > 0 then 
            exports["vertex-base"]:FetchComponent("Logger"):Critical("ObjectPlacer", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
	end)
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("ObjectPlacer", _PLACER)
end)