...
function RetrieveObjectsComponents()
	...
	Objects = exports["vertex-base"]:FetchComponent("Objects")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Objects", {
        "Callbacks",
        "Notification",
        "Targeting",
        "Inventory",
		...
		if #error > 0 then 
            exports["vertex-base"]:FetchComponent("Logger"):Critical("Objects", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Objects", _OBJECTS)
end)
