...
function RetrieveComponents()
	...
	Default = exports["vertex-base"]:FetchComponent("Default")
	...
	Police = exports["vertex-base"]:FetchComponent("Police")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Properties", {
		"Callbacks",
		"Middleware",
		"Logger",
		"Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Properties", PROPERTIES)
end)
