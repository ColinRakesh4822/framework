...
function RetrieveComponents()
	...
	Visuals = exports["vertex-base"]:FetchComponent("Visuals")
	RegisterChatCommands()
end

AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Visuals", {
		"Chat",
        "Visuals",
	}, function(error)
		if #error > 0 then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Visuals", VISUALS)
end)
