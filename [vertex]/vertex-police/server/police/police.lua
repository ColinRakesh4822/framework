...
function RetrieveComponents()
	...
	Handcuffs = exports["vertex-base"]:FetchComponent("Handcuffs")
	...
	Radar = exports["vertex-base"]:FetchComponent("Radar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Police", {
		"Database",
		"Middleware",
		"Callbacks",
		"Logger",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Police", POLICE)
end)
