COMPONENTS.Discord = {
	...
	RichPresence = function(self)
		...
		SetDiscordRichPresenceAssetText("Join Today: vertexRP.com")
		--SetDiscordRichPresenceAssetSmall("info")
		SetDiscordRichPresenceAction(0, "Register at vertexRP.net", "https://vertexrp.com")
		SetDiscordRichPresenceAction(1, "Join Our Discord", "https://discord.gg/vertexrp")
