local function CheckVersion()
    PerformHttpRequest('https://raw.githubusercontent.com/vertex-Framework/vertex-VersionCheckers/main/vertex-base.txt', function(err, newestVersion, headers)
        ...
        if isLatestVersion then
            ...
            print('')
            print('  Update Now: ^3https://github.com/vertex-Framework/vertex-base^0')
            print('^5=======================================================^0')
            print('')
        end
    end)
