...
local function GetPlayerPrimaryIdentifier(src)
    local primary = GetConvar('vertex_primary_identifier', 'license')
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Queue", QUEUE)
end)

AddEventHandler("Queue:Shared:DependencyUpdate", RetrieveComponents)
function RetrieveComponents()
	c = exports["vertex-base"]:FetchComponent("Config")
	Database = exports["vertex-base"]:FetchComponent("Database")
	WebAPI = exports["vertex-base"]:FetchComponent("WebAPI")
	Punishment = exports["vertex-base"]:FetchComponent("Punishment")
	Queue = exports["vertex-base"]:FetchComponent("Queue")
	Convar = exports["vertex-base"]:FetchComponent("Convar")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Queue", {
		"Config",
		"Database",
		"WebAPI",
		"Punishment",
...
CreateThread(function()
	...
	if not exports["vertex-base"]:FetchComponent("WebAPI").Enabled then
