Config = {
	...
	Strings = {
		...
		NoIdentifier = "Could Not Find Account Identifier, Relaunch FiveM and try again.",
		NoSteamIdentifier = "Could Not Find Steam Identifier, Relaunch FiveM and try again. (Make Sure Steam is Open & Logged In)",
		NotReady = "The vertex Framework server has not yet finished loading, please try again in a few minutes.",
