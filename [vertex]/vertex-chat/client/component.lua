...
AddEventHandler('Chat:Client:ReceiveMe', function(sender, uid, message, isDice)
    ...
    exports['vertex-base']:FetchComponent('Logger'):Trace('Me', string.format('Sender Source: %s; Sender Player: %s; My Source: %s; My Ped: %s', sender, senderClient, LocalPlayer.state.ID, LocalPlayer.state.ped))
