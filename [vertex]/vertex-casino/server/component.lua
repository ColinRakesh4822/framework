...
function RetrieveComponents()
	...
	Casino = exports["vertex-base"]:FetchComponent("Casino")
	Loot = exports["vertex-base"]:FetchComponent("Loot")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Casino", {
		"Fetch",
		"Utils",
        "Execute",
        "Chat",
		...
		if #error > 0 then 
            exports["vertex-base"]:FetchComponent("Logger"):Critical("Casino", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Casino", _CASINO)
end)
