...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Banking", {
		"Fetch",
		"Utils",
        "Execute",
        "Chat",
		...
		if #error > 0 then
			exports["vertex-base"]:FetchComponent("Logger"):Critical("Banking", "Failed To Load All Dependencies")
			return
		end
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Banking", _BANKING)
end)
