...
function RetrieveComponents()
	...
	Locations = exports["vertex-base"]:FetchComponent("Locations")
	Game = exports["vertex-base"]:FetchComponent("Game")
	Weed = exports["vertex-base"]:FetchComponent("Weed")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Weed", {
		"Database",
		"Callbacks",
		"Logger",
		"Middleware",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["vertex-base"]:RegisterComponent("Weed", WEED)
end)
