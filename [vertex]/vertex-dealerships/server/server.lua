...
function RetrieveComponents()
    ...
    Dealerships = exports['vertex-base']:FetchComponent('Dealerships')
...
AddEventHandler('Core:Shared:Ready', function()
    exports['vertex-base']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['vertex-base']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
