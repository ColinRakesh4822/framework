...
function RetrieveComponents()
    ...
    Billboards = exports["vertex-base"]:FetchComponent("Billboards")
    Regex = exports["vertex-base"]:FetchComponent("Regex")
end
...
AddEventHandler("Core:Shared:Ready", function()
	exports["vertex-base"]:RequestDependencies("Billboards", {
		...
		if #error > 0 then 
            exports["vertex-base"]:FetchComponent("Logger"):Critical("Billboards", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function(component)
	exports["vertex-base"]:RegisterComponent("Billboards", _BILLBOARDS)
end)
